...
Falsch ist also `105663 Datei 000001.txt`, korrekt wäre `000001 Datei 105663.txt`.

Korrigiere den Fehler für alle Dateien.

# 3. Sinnvolles Strukturieren von Daten (25 Minuten)
...
Überlege dir auf jeden Fall vorher grob, wie du `2.` und `3.` lösen wirst.

1. Erstelle den Datentypen `Person` (Dataclass), welcher zu den Daten passt.
